...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    accent: "from-cyan-500/30 via-indigo-500/15 to-blue-500/10",
  },
  {
    id: "email",
  ...
  },
  {
    ...
    featured: true,
    description:
      "Extract mood, stress, focus, and grounded coaching suggestions.",
...
const PAGE_COMPONENTS = {
  dashboard: Dashboard,
  org_knowledge: OrganizationKnowledge,
